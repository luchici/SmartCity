...
class HtmlFormTesting {
    ...
    void loginSubmitValidUser() throws Exception {
        LoginData expectedUser = new LoginData("TestUsername", "TestPassword");
    ...
    void signupSubmitValidUser() throws Exception {
        NewAccountDto expectedUser = new NewAccountDto("Test Firstname", "Test Lastname", "TestUsername", "Test HomeCity", LocalDate.now(), "Test Email", "TestPassword");
        mockMvc.perform(post("/login")
                        .contentType(APPLICATION_FORM_URLENCODED)
